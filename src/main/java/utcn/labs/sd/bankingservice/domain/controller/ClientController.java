...
class ClientController {
    ...
    @ApiOperation(value = "findAccountsByClient", tags = SwaggerTags.CLIENT_TAG)
    @RequestMapping(value = "/clientId/{clientId}", method = RequestMethod.GET)
    public List<AccountDTO> findAccountByClient(@PathVariable("clientId") String clientId){
